...
function chart_line(options) { //{{{
  this.options = options;
} //}}}

chart_line.prototype.style = function() { //{{{
  return `
#test1 {
  margin: 0;
  padding: 0;
...
chart_line.prototype.script = function() { //{{{
  const opt = this.options;

  const d3legend =`function d3Legend() {
  ...
  const d3linewithlegend = `function d3LineWithLegend() {
